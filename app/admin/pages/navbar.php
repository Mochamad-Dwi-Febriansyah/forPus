                ...
                <li class="dropdown messages-menu">
                    <a style="cursor: pointer;" class="dropdown-toggle" data-toggle="dropdown" id="badgePesan">
                        ...
                        if ($jumlah_pesan == null) {
                            ...
                            echo "<i class='fa fa-envelope'></i><span class='label label-danger'></span>";
                        } else {
                            echo "<i class='fa fa-envelope'></i><span class='label label-danger'>" . $jumlah_pesan . "</span>";
                        }
                        ?>
                    </a>
                    ...
                    <ul class="dropdown-menu" id="Pesan">
                        ...
                        <li>
                            <ul class="menu">
                                ...
                                $query_pesan1 = mysqli_query($koneksi, "SELECT * FROM messages WHERE incoming_msg_id = '$kode_saya' AND status = '$default'");
                                while ($row_pesan1 = mysqli_fetch_assoc($query_pesan1)) {
                                ?>
                                    <li>
                                        <!-- start message -->
                                        <a href="chat?user_id=<?= $row_pesan1['outgoing_msg_id']; ?>"> 
                                            <div class="pull-left">
                                            ...
                                            <h4 style="font-family: 'Quicksand', sans-serif">
                                                ...
                                                $kode_user_pengirim = $row_pesan1['outgoing_msg_id'];
                                                $id2 = $_SESSION['id_user'];

                                                $query_cek_verif = mysqli_query($koneksi, "SELECT * FROM user WHERE unique_id = '$kode_user_pengirim'");
                                                $row_cek = mysqli_fetch_array($query_cek_verif);
                                                ?>

                                                <?php
                                                if ($row_cek['verif'] == "Tidak") {
                                                    echo "$row_pesan1[outgoing_msg_id]";
                                                } else {
                                                    echo "$row_pesan1[outgoing_msg_id] " . "<i class='fa fa-check-circle text-info' title='User Terverifikasi' data-toggle='tooltip' data-placement='bottom'></i>";
                                                }
                                                ?>
                                            </h4>
                ...
                <li class="dropdown notifications-menu">
                    <a style="cursor: pointer;" class="dropdown-toggle" data-toggle="dropdown" id="badgeNotif">
                        ...
                        if ($jumlah_notif == null) {
                            ...
                            echo "<i class='fa fa-bell'></i><span class='label label-danger'>" . $jumlah_notif . "</span>";
                        }
                        ?>
                    </a>
