        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <form action="pages/function/Profile.php" method="POST" enctype="multipart/form-data">
                        <?php
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?= $row['unique_id']; ?>" disabled>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Foto Anda <small style="color: red;"></small></label>
            ...
            <div class="col-md-4">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <!-- -->
                        <p style="font-weight: bold;">Kode Anggota : <?= $row['unique_id']; ?></p>
                        ...
                        <img src="<?php echo $_SESSION['foto']; ?>" height="80" width="80" class="img-circle" alt="User Image" />
