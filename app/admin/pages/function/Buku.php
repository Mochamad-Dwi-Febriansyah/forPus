...
if ($_GET['act'] == "tambah") {
    ...
    $sql = "INSERT INTO buku(judul_buku,kategori_buku,penerbit_buku,pengarang,tahun_terbit,isbn,jumlah_halaman,j_buku_baik,j_buku_rusak,link_buku)
        VALUES('" . $judul_buku . "','" . $kategori_buku . "','" . $penerbit_buku . "','" . $pengarang . "','" . $tahun_terbit . "'
        ,'" . $isbn . "', '" . $jumlah_halaman . "' , '" . $j_buku_baik . "', '" . $j_buku_rusak . "','" . $link_buku . "')";
    ...
    $query = "UPDATE buku SET judul_buku = '$judul_buku', kategori_buku = '$kategori_buku', penerbit_buku = '$penerbit_buku', 
                pengarang = '$pengarang', tahun_terbit = '$tahun_terbit', isbn = '$isbn', jumlah_halaman = '$jumlah_halaman', j_buku_baik = '$j_buku_baik', j_buku_rusak = '$j_buku_rusak', link_buku ='$link_buku' ";
